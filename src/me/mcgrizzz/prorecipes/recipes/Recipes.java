...
public class Recipes implements Listener{
	...
	boolean changed = false;
		...
		public ArrayList<RecipeShapeless> shapeless = new ArrayList<RecipeShapeless>();
		public ArrayList<RecipeShaped> shaped = new ArrayList<RecipeShaped>();
		public ArrayList<RecipeFurnace> fur = new ArrayList<RecipeFurnace>();
		public ArrayList<RecipeChest> chest = new ArrayList<RecipeChest>();
			...
			for(int b = 9; b < 45; b++){
				if((b-1) % 9 == 0 || (b-2) % 9 == 0 || (b-3) % 9 == 0 || (b-4) % 9 == 0){
					if(i.getItem(b) != null && !i.getItem(b).getType().equals(Material.AIR)){
						if(safe && it != null){
							if(ItemUtils.itemToStringBlob(i.getItem(b)).equalsIgnoreCase(ItemUtils.itemToStringBlob(it))){
								safe = false;
								continue;
							}
						}
